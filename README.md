...
- it also includes an experimental proof that exact same-cycle `BORROW` synthesis still finds no candidate across a small representative set of existing-borrower Base fixtures
